...
public class BoardJComponent extends JComponent implements KeyListener {
	...
	public void keyPressed(KeyEvent e) {
		switch (e.getKeyCode()) {
			case KeyEvent.VK_LEFT -> lastPressedDirection = Direction.LEFT;
			case KeyEvent.VK_RIGHT -> lastPressedDirection = Direction.RIGHT;
			case KeyEvent.VK_UP -> lastPressedDirection = Direction.UP;
			case KeyEvent.VK_DOWN -> lastPressedDirection = Direction.DOWN;
			case KeyEvent.VK_A -> lastPressedDirection = Direction.A;
			case KeyEvent.VK_D -> lastPressedDirection = Direction.D;
			case KeyEvent.VK_W -> lastPressedDirection = Direction.W;
			case KeyEvent.VK_S -> lastPressedDirection = Direction.S;
		}
	}
